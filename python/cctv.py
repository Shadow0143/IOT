...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.url_1 = "rtsp://SHANVIA TECH SOLUTIONS_5G:AvijitChandan@255.255.255.255:8000/cam/realmonitor?channel=1&subtype=0"
        self.url_2 = "rtsp://<Username>:<Password>@<IP Address>:8000/cam/realmonitor?channel=1&subtype=0"
        self.url_3 = "rtsp://<Username>:<Password>@<IP Address>:8000/cam/realmonitor?channel=1&subtype=0"
